...
import { HiHeart, HiChat, HiUserAdd, HiCheck, HiBell } from 'react-icons/hi';
          ...
          return (
            <div
              ...
              style={{
                ...
                background: notif.read ? 'white' : '#FFF0F8',
                borderLeft: notif.read ? 'none' : '3px solid #E91E8C',
                cursor: 'pointer',
              }}
            ...
            >
              ...
              <div style={{ position: 'relative', flexShrink: 0 }}>
                <img
                  src={notif.fromPhoto || `https://ui-avatars.com/api/?name=${encodeURIComponent(notif.fromName || 'U')}&background=E91E8C&color=fff`}
              ...
              {!notif.read && (
                <div style={{ width: 9, height: 9, background: '#E91E8C', borderRadius: '50%', flexShrink: 0 }} />
              )}
            </div>
          );
        })
