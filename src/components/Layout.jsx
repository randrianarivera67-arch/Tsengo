          ...
          <div onClick={() => { navigate(`/profile/${currentUser?.uid}`); setDrawerOpen(false); }}
            ...
            <div style={{ minWidth: 0 }}>
              <p style={{ fontWeight: 700, fontSize: 14, color: text, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                ...
                {userProfile.isVip && <img src='/vip-badge.png' style={{ width:20, height:20, marginLeft:4, verticalAlign:'middle', display:'inline-block', flexShrink:0 }} alt='VIP'/>}
              </p>
                    ...
                    <div key={u.id} onClick={() => { navigate(`/profile/${u.id}`); setSearch(''); setSearchOpen(false); }}
                      ...
                      <div>
                        <p style={{ fontWeight: 600, fontSize: 13, color: text }}>
                          {u.fullName}
                          {u.isVip && <img src='/vip-badge.png' style={{ width:20, height:20, marginLeft:4, verticalAlign:'middle', display:'inline-block', flexShrink:0 }} alt='VIP'/>}
                        </p>
