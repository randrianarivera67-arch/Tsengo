    ...
    <div style={{ padding: '16px 12px' }}>
      ...
      <div className="card" style={{ padding: 16, marginBottom: 16, display: 'flex', alignItems: 'center', gap: 12 }}>
        <div style={{ position: 'relative' }}>
          ...
          />
          {userProfile?.isVip && (
            <svg style={{ marginLeft:4, verticalAlign:'middle', display:'inline-block', flexShrink:0 }} width='18' height='18' viewBox='0 0 24 24'><circle cx='12' cy='12' r='12' fill='#E91E8C'/><path d='M7 12.5l3.5 3.5 6.5-7' stroke='white' strokeWidth='2.2' strokeLinecap='round' strokeLinejoin='round' fill='none'/></svg>
          )}
        </div>
        <div style={{ flex: 1 }}>
