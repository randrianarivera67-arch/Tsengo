        ...
        return (
          ...
          <div className="card post-card animate-fade" style={{ marginBottom:14, border:boosted?'1px solid #a855f755':undefined, position:'relative', overflow:'hidden' }}>
            ...
            <div style={(() => {
              ...
              return {
                position:'absolute', top:boosted?34:10, left:30, right:30, zIndex:4,
            ...
            {(() => {
              ...
              return (
                ...
                {post.mediaURLs?.length > 1 ? (
                  ...
                  <div className='post-actions-row' style={{ position:'absolute', left:30, right:30, bottom:10, zIndex:3, margin:0, background:'rgba(255,255,255,.95)', backdropFilter:'blur(14px)', WebkitBackdropFilter:'blur(14px)', borderRadius:100, boxShadow:'0 4px 16px rgba(5,5,5,.18)', padding:6, border:'none' }}>
