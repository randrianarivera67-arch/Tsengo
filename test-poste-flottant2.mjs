...
ok('manidina : absolute bottom', H.includes("position:'absolute', left:30, right:30, bottom:10, zIndex:3"));
...
ok('manidina raha canFloat', H.includes("position:'absolute', top:boosted?34:10, left:30, right:30, zIndex:4"));
